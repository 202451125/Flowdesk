...
export default function Settings() {
  ...
  const handleProfileSave = async () => {
    ...
    try {
      await axios.put(`http://127.0.0.1:5000/users/${user.id}`, { name, email });
  ...
  const handlePasswordChange = async () => {
    ...
    setPwdLoading(true);
    try {
      await axios.put(`http://127.0.0.1:5000/users/${user.id}/password`, {
      ...
      showSnack("Current password is incorrect.", "error");
    } finally {
      setPwdLoading(false);
    }
  };
